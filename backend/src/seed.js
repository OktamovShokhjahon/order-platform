...
const DEFAULT_FOOD_IMAGE = '/uploads/burger.png';
...
const seedData = async () => {
  try {
    ...
    const categories = await Category.insertMany([
      { name: { uz: 'Burgerlar', ru: 'Бургеры', en: 'Burgers' }, image: '' },
      { name: { uz: 'Pitsa', ru: 'Пицца', en: 'Pizza' }, image: '' },
      { name: { uz: 'Sushi', ru: 'Суши', en: 'Sushi' }, image: '' },
      { name: { uz: 'Salatlar', ru: 'Салаты', en: 'Salads' }, image: '' },
      { name: { uz: 'Ichimliklar', ru: 'Напитки', en: 'Drinks' }, image: '' },
      { name: { uz: 'Shirinliklar', ru: 'Десерты', en: 'Desserts' }, image: '' },
    ]);
